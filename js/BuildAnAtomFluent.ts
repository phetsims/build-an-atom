...
addToMapIfDefined( 'a11y_common_atomAccessibleList_atomStateLeadingParagraph', 'a11y.common.atomAccessibleList.atomStateLeadingParagraphStringProperty' );
addToMapIfDefined( 'a11y_common_atomAccessibleList_checkboxesListLeadingParagraph', 'a11y.common.atomAccessibleList.checkboxesListLeadingParagraphStringProperty' );
addToMapIfDefined( 'a11y_common_atomAccessibleList_accessibleHeading', 'a11y.common.atomAccessibleList.accessibleHeadingStringProperty' );
addToMapIfDefined( 'a11y_common_atomAccessibleList_builtAtom', 'a11y.common.atomAccessibleList.builtAtomStringProperty' );
addToMapIfDefined( 'a11y_common_atomAccessibleList_nucleusInfoFull', 'a11y.common.atomAccessibleList.nucleusInfoFullStringProperty' );
addToMapIfDefined( 'a11y_common_atomAccessibleList_nucleusInfoProtons', 'a11y.common.atomAccessibleList.nucleusInfoProtonsStringProperty' );
addToMapIfDefined( 'a11y_common_atomAccessibleList_nucleusInfoNeutrons', 'a11y.common.atomAccessibleList.nucleusInfoNeutronsStringProperty' );
addToMapIfDefined( 'a11y_common_atomAccessibleList_nucleusInfoEmpty', 'a11y.common.atomAccessibleList.nucleusInfoEmptyStringProperty' );
addToMapIfDefined( 'a11y_common_atomAccessibleList_shellInfoFull', 'a11y.common.atomAccessibleList.shellInfoFullStringProperty' );
addToMapIfDefined( 'a11y_common_atomAccessibleList_cloudInfoFull', 'a11y.common.atomAccessibleList.cloudInfoFullStringProperty' );
addToMapIfDefined( 'a11y_common_atomAccessibleList_shellInfoEmpty', 'a11y.common.atomAccessibleList.shellInfoEmptyStringProperty' );
addToMapIfDefined( 'a11y_common_atomAccessibleList_cloudInfoEmpty', 'a11y.common.atomAccessibleList.cloudInfoEmptyStringProperty' );
addToMapIfDefined( 'a11y_common_atomAccessibleList_accessibleParagraph', 'a11y.common.atomAccessibleList.accessibleParagraphStringProperty' );
addToMapIfDefined( 'a11y_common_atomAccessibleList_nucleusContains', 'a11y.common.atomAccessibleList.nucleusContainsStringProperty' );
...
addToMapIfDefined( 'a11y_symbolScreen_symbol_accessibleList_symbol', 'a11y.symbolScreen.symbol.accessibleList.symbolStringProperty' );
addToMapIfDefined( 'a11y_symbolScreen_symbol_accessibleList_atomicNumber', 'a11y.symbolScreen.symbol.accessibleList.atomicNumberStringProperty' );
addToMapIfDefined( 'a11y_symbolScreen_symbol_accessibleList_massNumber', 'a11y.symbolScreen.symbol.accessibleList.massNumberStringProperty' );
addToMapIfDefined( 'a11y_symbolScreen_symbol_accessibleList_charge', 'a11y.symbolScreen.symbol.accessibleList.chargeStringProperty' );
...
addToMapIfDefined( 'a11y_gameScreen_components_chemicalSymbol_accessibleList_leadingParagraph', 'a11y.gameScreen.components.chemicalSymbol.accessibleList.leadingParagraphStringProperty' );
addToMapIfDefined( 'a11y_gameScreen_components_chemicalSymbol_accessibleList_name', 'a11y.gameScreen.components.chemicalSymbol.accessibleList.nameStringProperty' );
addToMapIfDefined( 'a11y_gameScreen_components_chemicalSymbol_accessibleList_symbol', 'a11y.gameScreen.components.chemicalSymbol.accessibleList.symbolStringProperty' );
addToMapIfDefined( 'a11y_gameScreen_components_chemicalSymbol_accessibleList_atomicNumber', 'a11y.gameScreen.components.chemicalSymbol.accessibleList.atomicNumberStringProperty' );
addToMapIfDefined( 'a11y_gameScreen_components_chemicalSymbol_accessibleList_massNumber', 'a11y.gameScreen.components.chemicalSymbol.accessibleList.massNumberStringProperty' );
addToMapIfDefined( 'a11y_gameScreen_components_chemicalSymbol_accessibleList_charge', 'a11y.gameScreen.components.chemicalSymbol.accessibleList.chargeStringProperty' );
...
const BuildAnAtomFluent = {
  ...
  a11y: {
    common: {
      ...
      atomAccessibleList: {
        atomStateLeadingParagraph: new FluentPattern<{ model: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_common_atomAccessibleList_atomStateLeadingParagraph', _.get( BuildAnAtomStrings, 'a11y.common.atomAccessibleList.atomStateLeadingParagraphStringProperty' ), [{"name":"model"}] ),
        checkboxesListLeadingParagraphStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_common_atomAccessibleList_checkboxesListLeadingParagraph', _.get( BuildAnAtomStrings, 'a11y.common.atomAccessibleList.checkboxesListLeadingParagraphStringProperty' ) ),
        accessibleHeadingStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_common_atomAccessibleList_accessibleHeading', _.get( BuildAnAtomStrings, 'a11y.common.atomAccessibleList.accessibleHeadingStringProperty' ) ),
        builtAtomStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_common_atomAccessibleList_builtAtom', _.get( BuildAnAtomStrings, 'a11y.common.atomAccessibleList.builtAtomStringProperty' ) ),
        nucleusInfoFull: new FluentPattern<{ neutrons: number | 'one' | number | 'other' | TReadOnlyProperty<number | 'one' | number | 'other'>, protons: number | 'one' | number | 'other' | TReadOnlyProperty<number | 'one' | number | 'other'> }>( fluentSupport.bundleProperty, 'a11y_common_atomAccessibleList_nucleusInfoFull', _.get( BuildAnAtomStrings, 'a11y.common.atomAccessibleList.nucleusInfoFullStringProperty' ), [{"name":"neutrons","variants":[{"type":"number","value":"one"},{"type":"number","value":"other"}]},{"name":"protons","variants":[{"type":"number","value":"one"},{"type":"number","value":"other"}]}] ),
        nucleusInfoProtons: new FluentPattern<{ protons: number | 'one' | number | 'other' | TReadOnlyProperty<number | 'one' | number | 'other'> }>( fluentSupport.bundleProperty, 'a11y_common_atomAccessibleList_nucleusInfoProtons', _.get( BuildAnAtomStrings, 'a11y.common.atomAccessibleList.nucleusInfoProtonsStringProperty' ), [{"name":"protons","variants":[{"type":"number","value":"one"},{"type":"number","value":"other"}]}] ),
        nucleusInfoNeutrons: new FluentPattern<{ neutrons: number | 'one' | number | 'other' | TReadOnlyProperty<number | 'one' | number | 'other'> }>( fluentSupport.bundleProperty, 'a11y_common_atomAccessibleList_nucleusInfoNeutrons', _.get( BuildAnAtomStrings, 'a11y.common.atomAccessibleList.nucleusInfoNeutronsStringProperty' ), [{"name":"neutrons","variants":[{"type":"number","value":"one"},{"type":"number","value":"other"}]}] ),
        nucleusInfoEmptyStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_common_atomAccessibleList_nucleusInfoEmpty', _.get( BuildAnAtomStrings, 'a11y.common.atomAccessibleList.nucleusInfoEmptyStringProperty' ) ),
        shellInfoFull: new FluentPattern<{ inner: number | 'one' | number | 'other' | TReadOnlyProperty<number | 'one' | number | 'other'>, outer: number | 'one' | number | 'other' | TReadOnlyProperty<number | 'one' | number | 'other'> }>( fluentSupport.bundleProperty, 'a11y_common_atomAccessibleList_shellInfoFull', _.get( BuildAnAtomStrings, 'a11y.common.atomAccessibleList.shellInfoFullStringProperty' ), [{"name":"inner","variants":[{"type":"number","value":"one"},{"type":"number","value":"other"}]},{"name":"outer","variants":[{"type":"number","value":"one"},{"type":"number","value":"other"}]}] ),
        cloudInfoFull: new FluentPattern<{ value: number | 'one' | number | 'other' | TReadOnlyProperty<number | 'one' | number | 'other'> }>( fluentSupport.bundleProperty, 'a11y_common_atomAccessibleList_cloudInfoFull', _.get( BuildAnAtomStrings, 'a11y.common.atomAccessibleList.cloudInfoFullStringProperty' ), [{"name":"value","variants":[{"type":"number","value":"one"},{"type":"number","value":"other"}]}] ),
        shellInfoEmptyStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_common_atomAccessibleList_shellInfoEmpty', _.get( BuildAnAtomStrings, 'a11y.common.atomAccessibleList.shellInfoEmptyStringProperty' ) ),
        cloudInfoEmptyStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_common_atomAccessibleList_cloudInfoEmpty', _.get( BuildAnAtomStrings, 'a11y.common.atomAccessibleList.cloudInfoEmptyStringProperty' ) ),
        accessibleParagraphStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_common_atomAccessibleList_accessibleParagraph', _.get( BuildAnAtomStrings, 'a11y.common.atomAccessibleList.accessibleParagraphStringProperty' ) ),
    ...
    symbolScreen: {
      ...
      symbol: {
        ...
        accessibleList: {
          symbol: new FluentPattern<{ symbol: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_symbolScreen_symbol_accessibleList_symbol', _.get( BuildAnAtomStrings, 'a11y.symbolScreen.symbol.accessibleList.symbolStringProperty' ), [{"name":"symbol"}] ),
          atomicNumber: new FluentPattern<{ value: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_symbolScreen_symbol_accessibleList_atomicNumber', _.get( BuildAnAtomStrings, 'a11y.symbolScreen.symbol.accessibleList.atomicNumberStringProperty' ), [{"name":"value"}] ),
          massNumber: new FluentPattern<{ value: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_symbolScreen_symbol_accessibleList_massNumber', _.get( BuildAnAtomStrings, 'a11y.symbolScreen.symbol.accessibleList.massNumberStringProperty' ), [{"name":"value"}] ),
          charge: new FluentPattern<{ value: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_symbolScreen_symbol_accessibleList_charge', _.get( BuildAnAtomStrings, 'a11y.symbolScreen.symbol.accessibleList.chargeStringProperty' ), [{"name":"value"}] )
        },
    ...
    gameScreen: {
      ...
      components: {
        ...
        neutralOrIonRadioButtons: {
          ...
          accessibleHelpTextStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_gameScreen_components_neutralOrIonRadioButtons_accessibleHelpText', _.get( BuildAnAtomStrings, 'a11y.gameScreen.components.neutralOrIonRadioButtons.accessibleHelpTextStringProperty' ) )
        },
        chemicalSymbol: {
          ...
          accessibleList: {
            leadingParagraphStringProperty: new FluentConstant( fluentSupport.bundleProperty, 'a11y_gameScreen_components_chemicalSymbol_accessibleList_leadingParagraph', _.get( BuildAnAtomStrings, 'a11y.gameScreen.components.chemicalSymbol.accessibleList.leadingParagraphStringProperty' ) ),
            name: new FluentPattern<{ name: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_gameScreen_components_chemicalSymbol_accessibleList_name', _.get( BuildAnAtomStrings, 'a11y.gameScreen.components.chemicalSymbol.accessibleList.nameStringProperty' ), [{"name":"name"}] ),
            symbol: new FluentPattern<{ symbol: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_gameScreen_components_chemicalSymbol_accessibleList_symbol', _.get( BuildAnAtomStrings, 'a11y.gameScreen.components.chemicalSymbol.accessibleList.symbolStringProperty' ), [{"name":"symbol"}] ),
            atomicNumber: new FluentPattern<{ protons: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_gameScreen_components_chemicalSymbol_accessibleList_atomicNumber', _.get( BuildAnAtomStrings, 'a11y.gameScreen.components.chemicalSymbol.accessibleList.atomicNumberStringProperty' ), [{"name":"protons"}] ),
            massNumber: new FluentPattern<{ mass: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_gameScreen_components_chemicalSymbol_accessibleList_massNumber', _.get( BuildAnAtomStrings, 'a11y.gameScreen.components.chemicalSymbol.accessibleList.massNumberStringProperty' ), [{"name":"mass"}] ),
            charge: new FluentPattern<{ charge: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_gameScreen_components_chemicalSymbol_accessibleList_charge', _.get( BuildAnAtomStrings, 'a11y.gameScreen.components.chemicalSymbol.accessibleList.chargeStringProperty' ), [{"name":"charge"}] )
          }
        },
        checkButton: {
