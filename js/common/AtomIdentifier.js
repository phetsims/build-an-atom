...
define( function( require ) {
  ...
  var nameTable = [
    '',
    require( 'string!BUILD_AN_ATOM/hydrogen' ),
    require( 'string!BUILD_AN_ATOM/helium' ),
    require( 'string!BUILD_AN_ATOM/lithium' ),
    require( 'string!BUILD_AN_ATOM/beryllium' ),
    require( 'string!BUILD_AN_ATOM/boron' ),
    require( 'string!BUILD_AN_ATOM/carbon' ),
    require( 'string!BUILD_AN_ATOM/nitrogen' ),
    require( 'string!BUILD_AN_ATOM/oxygen' ),
    require( 'string!BUILD_AN_ATOM/fluorine' ),
    require( 'string!BUILD_AN_ATOM/neon' ),
    require( 'string!BUILD_AN_ATOM/sodium' ),
    require( 'string!BUILD_AN_ATOM/magnesium' ),
    require( 'string!BUILD_AN_ATOM/aluminum' ),
    require( 'string!BUILD_AN_ATOM/silicon' ),
    require( 'string!BUILD_AN_ATOM/phosphorus' ),
    require( 'string!BUILD_AN_ATOM/sulfur' ),
    require( 'string!BUILD_AN_ATOM/chlorine' ),
    require( 'string!BUILD_AN_ATOM/argon' ),
    'Potassium',
    'Calcium',
    'Scandium',
    'Titanium',
