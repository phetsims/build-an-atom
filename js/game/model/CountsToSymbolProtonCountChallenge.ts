 ...
 * has to fill in the Proton Count number for an atom symbol.
 *
...
class CountsToSymbolProtonCountChallenge extends CountsToSymbolChallenge {
  ...
  public override createView( layoutBounds: Bounds2, tandem: Tandem ): CountsToSymbolChallengeView {
    return new CountsToSymbolChallengeView( this, layoutBounds, tandem.createTandem( 'countsToSymbolProtonCountChallengeView' ) );
  }
}

buildAnAtom.register( 'CountsToSymbolProtonCountChallenge', CountsToSymbolProtonCountChallenge );

export default CountsToSymbolProtonCountChallenge;