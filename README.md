...
(5) Open in the browser: `http://localhost/build-an-atom/build-an-atom_en.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
...
(3) Open in the browser: `http://localhost/build-an-atom/build/adapted-from-phet/build-an-atom_en_adapted-from-phet.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
